...
class CorticalColumn(nn.Module):
    ...
    def apical_update(self, apical_features, neurons_activation, neighborhood_size=5):
        with torch.no_grad():
            ...
            cooperative_gate = torch.sigmoid(10 * (neighborhood_strength - 0.5))  # branch nonlinear gating
            oja_decay = self.apical_synapse * (neurons_activation ** 2)

            # Gated Hebbian plasticity modulated by dendritic cooperativity
